...
@include('layout.header')
      ...
      <div class="content-wrapper">
        ...
        <!-- Content -->
            ...
            <h4 class="py-3 mb-4">
  <span class="text-muted fw-light">Super Admin / </span> Account
</h4>
      ...
      <div class="card-body">
        ...
        <div class="info-container">
          ...
          <div class="d-flex justify-content-center">
            ...
            @if ($user->status == "1")
            <a href="{{ route('superadmin.status.update', ['id' => $user->id, 'status' => '0']) }}" class="btn btn-outline-danger">Suspend</a> 
            @elseif ($user->status == "0")
            <a href="{{ route('superadmin.status.update', ['id' => $user->id, 'status' => '1']) }}" class="btn btn-outline-success">Activate</a>
            @endif
  ...
  <div class="modal-dialog modal-lg modal-simple modal-edit-user">
    <div class="modal-content p-3 p-md-5">
      <div class="modal-body py-3 py-md-0">
        ...
        <form action="{{url('/superadminUpdate/'.$userDetails->id)}}" class="row g-4" method="POST">
          @csrf
          <div class="col-12 col-md-6">
            <div class="form-floating form-floating-outline">
              <input type="text" name="managementFirstName" class="form-control" value="{{$userDetails->first_name}}" />
              <label for="modalEditUserFirstName">First Name</label>
            </div>
          </div>
          <div class="col-12 col-md-6">
            <div class="form-floating form-floating-outline">
              <input type="text" name="managementLastName" class="form-control" value="{{$userDetails->last_name}}" />
              <label for="modalEditUserLastName">Last Name</label>
            </div>
          </div>
          <div class="col-12">
            <div class="form-floating form-floating-outline">
                <select name="managementRole" class="form-select">
                    <option value="Super Admin" {{ $userDetails->role == 'Super Admin' ? 'selected' : '' }}>Super Admin</option>
                    <option value="Admin" {{ $userDetails->role == 'Admin' ? 'selected' : '' }}>Admin</option>
                    <option value="Agent" {{ $userDetails->role == 'Agent' ? 'selected' : '' }}>Agent</option>
                  </select>
              <label for="modalEditUserName">Role</label>
            </div>
          </div>
          <div class="col-12 col-md-6">
            <div class="form-floating form-floating-outline">
              <input type="text" name="managementEmail" class="form-control" value="{{$userDetails->email}}" />
              <label for="modalEditUserEmail">Email</label>
            </div>
          </div>
          <div class="col-12 col-md-6">
            <div class="form-floating form-floating-outline">
              <input type="number" name="managementPhone" class="form-control" value="{{$userDetails->phone_no}}" />
              <label>Contact No</label>
            </div>
          </div>
          <div class="col-12 col-md-6">
            <div class="form-floating form-floating-outline">
              <select name="managementStatus" class="form-select">
          ...
          <div class="col-12 col-md-6">
            <div class="input-group input-group-merge mb-4">
              <div class="form-floating form-floating-outline">
                <input type="password" name="managementPassword" id="passwordInput" class="form-control" />
          ...
          <div class="col-12 col-md-6">
            <div class="input-group input-group-merge mb-4">
              <div class="form-floating form-floating-outline">
                <input type="password" name="managementConfirmPassword" id="passwordConfirmInput" class="form-control" />
